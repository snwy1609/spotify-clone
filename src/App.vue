            ...
            <button @click="openMenu = !openMenu" :class="openMenu ? 'bg-[#282828]' : 'bg-black'"
                ...
                <div class="flex items-center">
                    <img 
                      class="rounded-full" 
                      width="27"
                      src="https://yt3.ggpht.com/yti/AOXPAcV4jb9Ggu_niWOl1E7KRx8llF3jZ-DeRwiV2C1I=s88-c-k-c0x00ffffff-no-rj"    >
                    <div class="text-white text-[14px] ml-1.5 font-semibold">Jean Dev</div>
